...
export const ForgotPassStep1 = () => {
	...
	const step1ForgotPassSchema = z.object({
		email: z
			.string({
				required_error: "O e-mail é necessário para recuperar sua senha",
			})
	...
	return (
		<div className="flex gap-3 items-center w-full min-h-screen">
			...
			<Flex vertical justify="center" className="mx-auto w-full px-4 md:w-1/3">
				<div className="flex items-start flex-col gap-4 mb-3">
					<Button className="px-1" onClick={() => navigate(-1)} type="text">
						<Flex align="center" gap={10}>
							...
							<p className="text-gray-neutral-300">Voltar</p>
						</Flex>
					</Button>
					<img
						src={biodermisLogo}
					...
					<Typography.Title level={4}>Esqueceu sua senha?</Typography.Title>

					<Text>Insira os dados para recuperar sua senha</Text>

					<Text>
						Introduza o endereço de e-mail que utilizou quando aderiu e iremos
						enviar as instruções para repor a sua palavra-passe.
					</Text>
				</div>
