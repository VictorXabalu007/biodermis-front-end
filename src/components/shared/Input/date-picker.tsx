...
export const InputDatePicker = ({
	...
	return (
		<DatePicker
			className={twMerge(
				"w-full hover:border-gray-neutral-400 border-purple-solid-950 py-2 focus:border-gray-neutral-400",
				className,
			)}
			//@ts-ignore
			defaultValue={[
			...
			format={dateFormat}
			suffixIcon={
				<IoCalendarNumberOutline className={"fill-purple-solid-950 text-xl"} />
			}
			{...rest}
		/>
	);
